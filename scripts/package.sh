#!/usr/bin/env bash
# Build qbittorrent.zip (manifest.json at ROOT — required by install_plugin_from_zip)
...
FILE_URL="https://github.com/outcast1000/viboplr-qbittorrent/releases/latest/download/qbittorrent.zip"
...
zip -q qbittorrent.zip manifest.json index.js
echo "--- zip contents (manifest.json must have no dir prefix) ---"
unzip -l qbittorrent.zip
